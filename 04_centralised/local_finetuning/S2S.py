...
global_model_path = Path("models/S2S_global.keras" )  #load the global model
...
results_df.to_csv("fine_tuned_S2S_per_house_eval.csv", index=False)
...
summary_df.to_csv("fine_tuned_S2S_summary.csv", index=False)
print(summary_df)