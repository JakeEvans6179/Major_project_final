...
'''
2CNN-LSTM-Dense centralised validation screening on final cohort
'''
...
plt.title('Centralized 2CNN-LSTM-Dense: Training vs Validation Loss')
plt.xlabel('Epochs')
...
results_df.to_csv("centralised_2CNN_LSTM_Dense_per_house_validation_eval.csv", index=False)
...
summary_df = pd.DataFrame([{
    "model": "centralised_2CNN_LSTM_Dense",
...
summary_df.to_csv("centralised_2CNN_LSTM_Dense_validation_summary.csv", index=False)
print(summary_df)

model.save("2CNN_LSTM_Dense_global.keras")
