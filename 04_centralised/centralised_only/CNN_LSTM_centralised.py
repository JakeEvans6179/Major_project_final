...
'''
CNN-lstm centralised validation screening on final cohort
'''
...
plt.title('Centralized CNN-LSTM: Training vs Validation Loss')
plt.xlabel('Epochs')
...
results_df.to_csv("centralised_CNN_LSTM_per_house_validation_eval.csv", index=False)
...
summary_df.to_csv("centralised_CNN_LSTM_validation_summary.csv", index=False)
print(summary_df)

model.save("CNN_LSTM_global.keras")
