...
global_model_path = Path("chunk_checkpoints/global_chunk_034_CNN_LSTM_Dense.keras")  #find the best model from validation screening and use for fine tuning
...
results_df.to_csv("fine_tuned_CNN_LSTM_Dense_per_house_eval.csv", index=False)
...
summary_df = pd.DataFrame([{
    "model": "fine_tuned_CNN_LSTM_Dense",
...
summary_df.to_csv("fine_tuned_CNN_LSTM_Dense_summary.csv", index=False)
print(summary_df)
