...
'''
Testing for LSTM64_Dense
6 hour forecasting horizon 

validation metrics
'''

plots_dir = Path("house_plots_lstm64_dense")
...
for i, house_id in enumerate(house_ids, start=1):
    ...
    plt.ylabel("kWh")
    plt.title(f"{house_id} | 6-step forecast | LSTM64_Dense | Horizon t+1")
    plt.legend()
    plt.tight_layout()
    ...
    plt.xlabel("Val sample index")
    plt.ylabel("kWh")
    plt.title(f"{house_id} | 6-step forecast | LSTM64_Dense | Horizon t+3")
    plt.legend()
    plt.tight_layout()
    ...
    plt.xlabel("Val sample index")
    plt.ylabel("kWh")
    plt.title(f"{house_id} | 6-step forecast | LSTM64_Dense | Horizon t+6")
    plt.legend()
    plt.tight_layout()
...
print("\nPer-house LSTM64_Dense results:")
print(results_df.head())

print("\nLSTM64_Dense summary:")
...
summary_df.to_csv("lstm64_dense_localised_summary.csv", index=False)
print(summary_df)
